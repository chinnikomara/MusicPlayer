...
dpg.create_context()
dpg.create_viewport(title="Music Player",large_icon="icon.ico",small_icon="icon.ico")
pygame.mixer.init()
...
def update_slider():
	...
	while pygame.mixer.music.get_busy():
		...
		time.sleep(0.7)
	state=None
	dpg.configure_item("cstate",default_value=f"State: Idle")
...
with dpg.theme(tag="base"):
	with dpg.theme_component():
		dpg.add_theme_color(dpg.mvThemeCol_Button, (153, 51, 153))
		dpg.add_theme_color(dpg.mvThemeCol_ButtonActive, (255, 77, 255, 95))
		dpg.add_theme_color(dpg.mvThemeCol_ButtonHovered, (102, 102, 153))
...
with dpg.theme(tag="slider_thin"):
	with dpg.theme_component():
		dpg.add_theme_color(dpg.mvThemeCol_FrameBgActive, (102, 0, 102,99))
		dpg.add_theme_color(dpg.mvThemeCol_FrameBgHovered, (179, 0, 179,99))
		dpg.add_theme_color(dpg.mvThemeCol_SliderGrabActive, (255, 255, 255))
		dpg.add_theme_color(dpg.mvThemeCol_SliderGrab, (255, 255, 255))
		dpg.add_theme_color(dpg.mvThemeCol_FrameBg, (102, 0, 102,99))
		dpg.add_theme_style(dpg.mvStyleVar_GrabRounding, 3)
		dpg.add_theme_style(dpg.mvStyleVar_GrabMinSize, 30)

with dpg.theme(tag="slider"):
	with dpg.theme_component():
		dpg.add_theme_color(dpg.mvThemeCol_FrameBgActive, (250, 205, 2,99))
		dpg.add_theme_color(dpg.mvThemeCol_FrameBgHovered, (102, 0, 102,99))
		dpg.add_theme_color(dpg.mvThemeCol_SliderGrabActive, (255, 255, 255))
		dpg.add_theme_color(dpg.mvThemeCol_SliderGrab, (255, 255, 255))
		dpg.add_theme_color(dpg.mvThemeCol_FrameBg, (102, 0, 102,99))
		dpg.add_theme_style(dpg.mvStyleVar_GrabRounding, 3)
...
with dpg.window(tag="main",label="window title"):
	...
	with dpg.group(horizontal=True):
		with dpg.child_window(width=200,tag="sidebar"):
			dpg.add_text("My Music Gallery",color=(102, 255, 51))
			dpg.add_text("Build by Chinni Komara")
			dpg.add_spacer(height=2)
			dpg.add_button(label="Support",width=-1,height=23,callback=lambda:webbrowser.open(url="https://github.com/chinnikomara/MusicPlayer"))
